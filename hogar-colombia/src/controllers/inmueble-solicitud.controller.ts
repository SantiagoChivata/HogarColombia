...
export class InmuebleSolicitudController {
  ...
  async find(
    ...
    return this.inmuebleRepository.solicitud(id).find(filter);
  }
  ...
  async create(
    ...
    return this.inmuebleRepository.solicitud(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.inmuebleRepository.solicitud(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.inmuebleRepository.solicitud(id).delete(where);
  }
}
