...
export class ClienteSolicitudController {
  ...
  async find(
    ...
    return this.clienteRepository.cliente(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.cliente(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.cliente(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.cliente(id).delete(where);
  }
}
